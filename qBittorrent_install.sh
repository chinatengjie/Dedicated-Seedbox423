function qBittorrent_download {
    ...
    wget -O qbittorrent-nox https://github.com/Aniverse/qbittorrent-nox-static/releases/download/4.2.4/qbittorrent-nox.4.2.3.lt.1.1.14 && chmod +x $HOME/ qbittorrent-nox
}
